          ...
          <div className="space-y-3">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleCredentialChange("mailchimpApiKey", e.target.value)
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleCredentialChange("serverPrefix", e.target.value)
                }
                placeholder="us1"
              />
              <p className="text-xs text-muted-foreground mt-1">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleConfigurationChange("listId", e.target.value)
                    }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleConfigurationChange("fromName", e.target.value)
                    }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleConfigurationChange("fromEmail", e.target.value)
                    }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleConfigurationChange("replyTo", e.target.value)
                    }
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleCredentialChange("applicationPassword", e.target.value)
                }
    ...
    <div className="space-y-3">
      ...
      <div>
        ...
        <Select
          ...
          onValueChange={(value) => onChange("defaultStatus", value)}
        >
          <SelectTrigger>
    ...
    switch (platformType) {
      case "twitter":
        return {
          ...
          instructions:
            "Create a Twitter Developer Account and generate API keys from the Twitter Developer Portal.",
          fields: [
      ...
      case "facebook":
        return {
          ...
          instructions:
            "Create a Facebook App and generate an Access Token with pages_manage_posts permission.",
          fields: [
      ...
      case "instagram":
        return {
          ...
          instructions:
            "Use Facebook Developer Console to create Instagram Basic Display App.",
          fields: [
            {
              key: "appId",
      ...
      case "linkedin":
        return {
          ...
          instructions:
            "Create a LinkedIn App and generate OAuth 2.0 credentials.",
          fields: [
            {
              key: "clientId",
              label: "Client ID",
      ...
      case "tiktok":
        return {
          ...
          instructions:
            "Register for TikTok for Business API and obtain OAuth credentials.",
          fields: [
            {
              key: "appId",
              label: "App ID",
            ...
            },
            {
              ...
              placeholder: "comma-separated-advertiser-ids",
            },
          ],
  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        ...
        <Select
          value={configuration.scheduleTimezone}
          onValueChange={(value) => onChange("scheduleTimezone", value)}
        >
          <SelectTrigger>
