...
${brief.key_points?.slice(1, 3).map((point: any) => `The research reveals that ${point.toLowerCase()}, which has significant implications for organizations and professionals in this field.`).join(' ') || 'The research reveals key insights that have significant implications for organizations and professionals in this field.'}
